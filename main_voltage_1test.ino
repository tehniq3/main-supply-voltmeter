...
// ver.1test, "count" voltage from 170 to 260V for test casese
...
long intarziere = 500; // delayu after voltage is not ok
long intarziere2 = 250; // delayu after voltage is ok
